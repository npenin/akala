...
export default function evaluate<TNative extends number | bigint>(module: Module<TNative>, code: { expr?: IsomorphicBuffer, offset?: u32 }, cursor: Cursor, mem: Buffer, stack: (number | bigint)[] = [])
{
    const opCodes = code.expr;
    const buffer = opCodes;
