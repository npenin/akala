...
export default function tlsf<TNative extends bigint | u32>(module: Module<TNative>, arch: memory<TNative>, j: number = 3 | 4 | 5 | 6, splitSizeThreshold: number = 32)
{
  ...
  class Block
  {
    ...
    split(requestedSize: usize<TNative>, remainingBlock: Block): IsomorphicBuffer
    {
  ...
  function storeSl(offset: usize<TNative> | i32, value: usize<TNative>): IsomorphicBuffer
  {
    switch (j)
    {
      case 3:
...
export class Tlsf<TNative extends bigint | number> implements Allocator<TNative>
{
  ...
  constructor(private readonly module: Module<TNative>, private readonly arch: memory<TNative>, private readonly j: number = 3 | 4 | 5 | 6, private readonly splitSizeThreshold: number = 32)
  {
  }
  free(address: usize<TNative>)
  {
    return this.module.call(this.tlsf.free, [address], []);
  }
