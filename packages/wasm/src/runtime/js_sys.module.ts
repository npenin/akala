...
export function JsModule<TNative extends number | bigint>(module: Module<TNative>, jssysName: string = 'js-sys')
{
    ...
    return {
        ...
        getNumProperty: module.importFunc(jssysName, jssys.getProperty.name, [externref, i32], [externref]),
        getRefProperty: module.importFunc(jssysName, jssys.getProperty.name, [externref, externref], [externref]),
