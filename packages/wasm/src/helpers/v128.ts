...
export namespace v128
{
    export class i8 extends v128
    {
        ...
        public static pop()
        {
            return new i8(new IsomorphicBuffer(0));
        }
        ...
        public static fromLocal(index: indexes.local) { return new i8(new IsomorphicBuffer([local.get, index])); }
        public teeLocal(index: indexes.local) { return new i8(new IsomorphicBuffer([local.tee, index])); }
        public static fromGlobal(index: indexes.global) { return new i8(new IsomorphicBuffer([global.get, index])); }

        public static const(values: uint8[] | IsomorphicBuffer) { return new i8(mergeUInt8Arrays(transpiler.const, values)); }
    ...
    export class i16 extends v128
    {
        ...
        public static pop()
        {
            return new i16(new IsomorphicBuffer(0));
        }
        ...
        public static fromLocal(index: indexes.local) { return new i16(new IsomorphicBuffer([local.get, index])); }
        public teeLocal(index: indexes.local) { return new i16(new IsomorphicBuffer([local.tee, index])); }
        public static fromGlobal(index: indexes.global) { return new i16(new IsomorphicBuffer([global.get, index])); }
    ...
    export class i32 extends v128
    {
        ...
        public teeLocal(index: indexes.local) { return new i32(new IsomorphicBuffer([local.tee, index])); }
    ...
    export class f32 extends v128
    {
        ...
        public static fromGlobal(index: indexes.global) { return new f32(new IsomorphicBuffer([global.get, index])); }
    ...
    export class f64 extends v128
    {
        ...
        public static fromLocal(index: indexes.local) { return new f64(new IsomorphicBuffer([local.get, index])); }
        public teeLocal(index: indexes.local) { return new f64(new IsomorphicBuffer([local.tee, index])); }
        public static fromGlobal(index: indexes.global) { return new f64(new IsomorphicBuffer([global.get, index])); }
