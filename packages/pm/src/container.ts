...
namespace commands
{
	export interface container 
	{
		...
		dispatch (cmd:'map', ...args: [Argument0<typeof import('./commands/map').default>, Argument1<typeof import('./commands/map').default>, Argument2<typeof import('./commands/map').default>, Argument3<typeof import('./commands/map').default>, Argument4<typeof import('./commands/map').default>]): ReturnType<typeof import('./commands/map').default>
	...
	export interface proxy 
	{
		...
		'map'(...args: [Argument0<typeof import('./commands/map').default>, Argument1<typeof import('./commands/map').default>, Argument2<typeof import('./commands/map').default>, Argument3<typeof import('./commands/map').default>, Argument4<typeof import('./commands/map').default>]): ReturnType<typeof import('./commands/map').default>
