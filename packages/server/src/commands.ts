...
export namespace description 
	...
	export interface commands 
	{
		...
		dispatch (cmd:'remote-container', ...args:[Argument0<typeof import('./commands/remote-container').default>]): ReturnType<typeof import('./commands/remote-container').default>
