...
export namespace description 
	...
	export interface server 
	{
		...
		dispatch (cmd:'mode', ...args:[Argument0<typeof import('./../../../src/commands/mode').default>]): ReturnType<typeof import('./../../../src/commands/mode').default>
		dispatch (cmd:'remote-route', ...args:[Argument0<typeof import('./../../../src/commands/remote-route').default>, Argument1<typeof import('./../../../src/commands/remote-route').default>, Argument2<typeof import('./../../../src/commands/remote-route').default>]): ReturnType<typeof import('./../../../src/commands/remote-route').default>
		dispatch (cmd:'remove-asset', ...args:[Argument0<typeof import('./../../../src/commands/remove-asset').default>, Argument1<typeof import('./../../../src/commands/remove-asset').default>]): ReturnType<typeof import('./../../../src/commands/remove-asset').default>
		dispatch (cmd:'require', ...args:[Argument1<typeof import('./../../../src/commands/require').default>, Argument2<typeof import('./../../../src/commands/require').default>]): ReturnType<typeof import('./../../../src/commands/require').default>
		...
		dispatch (cmd:'webpack-alias', ...args:[Argument0<typeof import('./../../../src/commands/webpack-alias').default>, Argument1<typeof import('./../../../src/commands/webpack-alias').default>]): ReturnType<typeof import('./../../../src/commands/webpack-alias').default>
		dispatch (cmd:'webpack-html', ...args:[Argument0<typeof import('./../../../src/commands/webpack-html').default>]): ReturnType<typeof import('./../../../src/commands/webpack-html').default>
