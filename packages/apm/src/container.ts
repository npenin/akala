...
namespace apm
{
	export interface container 
	{
		...
		dispatch (cmd:'cache.add', ...args: [Argument0<typeof import('./commands/cache/add.js').default>, Argument1<typeof import('./commands/cache/add.js').default>, Argument2<typeof import('./commands/cache/add.js').default>]): ReturnType<typeof import('./commands/cache/add.js').default>
		...
		dispatch (cmd:'why', ...args: [Argument0<typeof import('./commands/why.js').default>]): ReturnType<typeof import('./commands/why.js').default>
	}
	export interface proxy 
	{
		'$init'(...args: [Argument0<typeof import('./commands/$init.js').default>]): ReturnType<typeof import('./commands/$init.js').default>
		'cache.add'(...args: [Argument0<typeof import('./commands/cache/add.js').default>, Argument1<typeof import('./commands/cache/add.js').default>, Argument2<typeof import('./commands/cache/add.js').default>]): ReturnType<typeof import('./commands/cache/add.js').default>
		...
		'why'(...args: [Argument0<typeof import('./commands/why.js').default>]): ReturnType<typeof import('./commands/why.js').default>
	}
