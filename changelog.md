...
* add default layout configuration for various collections in documentation efa460f
* add default layout configuration for various collections in documentation ac3280f
* add documentation files and update links for navigation 77a4730
...
* add parent and nav_order attributes to add-script.md for improved documentation structure 7aefa6c
* add parent and nav_order attributes to composer and control markdown files for improved documentation structure e7d09c1
* add parent and nav_order attributes to composer and control markdown files for improved documentation structure 1d4d1a5
* add parent and nav_order attributes to various markdown files for improved navigation 8f580bc
* add parent and nav_order attributes to various markdown files for improved navigation 2d47891
* add parent and title attributes to markdown files for improved documentation structure 0a0d63a
...
* add title to getting started documentation and enable nav folding for collections 2be3b2e
* add titles to command documentation and remove obsolete client/server files 12ab0e7
* add titles to command documentation and remove obsolete client/server files e9288a1
...
* https://sonarcloud.io/organizations/npenin/rules?open=typescript%3AS5852&rule_key=typescript%3AS5852 549c3db
* https://sonarcloud.io/organizations/npenin/rules?open=typescript%3AS6582&rule_key=typescript%3AS6582 18d0a6b
...
* https://sonarcloud.io/project/issues?open=AY-Kd-lIMBVWy2Eqm974&id=npenin_akala ac2f0a3
...
* https://sonarcloud.io/project/issues?open=AZEYUJUYYoc5uOIAntea&id=npenin_akala a2c7450
* https://sonarcloud.io/project/issues?open=AZEYUJYfYoc5uOIAntfT&id=npenin_akala 719449a
* https://sonarcloud.io/project/issues?open=AZEYUJYfYoc5uOIAntfT&id=npenin_akala a94a75f
* https://sonarcloud.io/project/issues?open=AZEYUJYfYoc5uOIAntfX&id=npenin_akala 1a8c5af
* https://sonarcloud.io/project/issues?open=AZEYUJYfYoc5uOIAntfX&id=npenin_akala b8b4fb4
* https://sonarcloud.io/project/issues?open=AZTuPPA3WVPY8wORAflX&id=npenin_akala 2e97d13
* https://sonarcloud.io/project/issues?open=AZTuPPCxWVPY8wORAflu&id=npenin_akala f720611
* https://sonarcloud.io/project/issues?open=AZTuPPDXWVPY8wORAfme&id=npenin_akala dec794a
...
* https://sonarcloud.io/project/issues?open=AZUcpsX6l4M-yVEnK0G2&id=npenin_akala ac2d490
* https://sonarcloud.io/project/issues?open=AZUcpsXwl4M-yVEnK0G0&id=npenin_akala a1d3e32
* https://sonarcloud.io/project/issues?open=AZUcpsYal4M-yVEnK0HA&id=npenin_akala 801ca1b
* https://sonarcloud.io/project/issues?open=AZUcpsYRl4M-yVEnK0G6&id=npenin_akala 498c8a0
* https://sonarcloud.io/project/issues?open=AZUm25-mcmo5mFGtK4ct&id=npenin_akala dcaa844
* https://sonarcloud.io/project/issues?open=AZVQt3Jddpj41gVLD2Y7&id=npenin_akala 780174e
* https://sonarcloud.io/project/issues?pullRequest=1552&open=AZW3SpjUXwCAWCXPixgu&id=npenin_akala 363162b
* https://sonarcloud.io/project/issues?pullRequest=1552&open=AZW3SpmCXwCAWCXPixgw&id=npenin_akala 8898632
* https://sonarcloud.io/project/issues?pullRequest=1552&open=AZW3SpmCXwCAWCXPixgx&id=npenin_akala a221322
* https://sonarcloud.io/project/issues?pullRequest=1552&open=AZW3SpmCXwCAWCXPixgy&id=npenin_akala a440c1c
* https://sonarcloud.io/project/issues?pullRequest=1552&open=AZW3SpmHXwCAWCXPixgz&id=npenin_akala 5c2694d
...
* remove parent attributes from markdown files for improved documentation clarity 0a2255b
* remove Popovers documentation and update index 78e50c8
* remove Popovers documentation and update index 811995c
...
* rename core to _core collection 7bae736
...
* sonar coverage discovery 5fce5ec
* sonar coverage discovery e28f9c5
* sonar coverage discovery 4d8a390
* sonar coverage discovery 58bf5ea
* sonar coverage discovery 01906f1
* sonar issues 4065e6a
* sonar issues 9210fe9
* sonar issues 386a343
* sonar issues 718f687
* sonar issues 46f2771
* sonar issues f0c5f92
* sonar issues 2af606b
...
* trying to fix already initialized context 6ea6279
* trying to fix already initialized context f5c18df
...
* update after core breaking change 282421b
...
* update documentation links and improve file creation logic 511789d
* update documentation links to remove file extensions 13f5429
* update documentation links to remove file extensions 586b67f
* update documentation structure and add new sections for configuration, jsonrpc, pm, and storage c6adcdf
* update documentation structure and add new sections for configuration, jsonrpc, pm, and storage c723c00
* update documentation structure by adding parent and nav_order for components and forms 376a98b
...
* update parent attributes in markdown files for improved documentation structure dc37d27
* update parent reference and add title for Processors & Triggers documentation 8bb2354
* update parent reference and add title for Processors & Triggers documentation 0471950
* update parent reference and title formatting in CLI documentation b2de995
* update parent reference and title formatting in CLI documentation 33a8a57
* update path configuration in documentation settings 55cb471
...
* event.pipe does not accept an EventEmitter any longer
